...
if (isset($_POST['submit'])) {
  ...
  if ($new_pass == $confirm_new_pass) {
    ...
    if ($new_pass == '123456') {
      $message = "Anda tidak bisa menggunakan password default !!";
      echo "<script type='text/javascript'>alert('$message');</script>";
    } else {
      $password_crypted = password_hash($new_pass, PASSWORD_BCRYPT);
      $updated_password_query = "UPDATE users SET users.password = '$password_crypted' WHERE users.username= '$username';";
      ...
      if ($updated_password_process) {
        ...
        $message = "Pergantian password gagal silahkan coba lagi !!";
        echo "<script type='text/javascript'>alert('$message');</script>";
      }
    }
    ...
    <div class="row d-flex align-items-center">
      ...
      <div class="col d-flex flex-column justify-content-center">
        ...
        <form action="" method="post" class="form-login d-flex flex-column justify-content-center">
          <div class="mb-3">
            <input type="password" class="form-control mb-4" id="new_pass" name="new_pass"
