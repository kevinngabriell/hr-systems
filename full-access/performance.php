...
<html lang="en">
  <head>
    ...
    <title>Performance HR Systems</title>
    <link
      ...
      <div class="row h-100">
        ...
        <div class="col-2" style="margin-left: 1%; margin-right: 1%">
          ...
          <a href="performance.php" class="sidebar-menu">
            <div class="row row-sidebar-menu">
              <div class="col-3">
                <img src="../Assets/Asset30.png" alt="" class="img-right-side" />
              </div>
        ...
        <nav class="navbar">
            ...
            <div class="row row-right-navbar">
              ...
              <div class="col">
                <a href="performance.php" class="nav-item nav-text-dashboard">Performance</a>
              </div>
        ...
        <div class="row d-flex align-items-center justify-content-center" style="text-align: center; margin-top: auto; margin-bottom: auto;">
            <img src="../Assets/Asset29.png" alt="" style="width: 30%;">
            <p class="under-construction-text">Under Construction</p>
            <p class="under-construction-text-desc">Halaman ini sedang dalam proses pengembangan dan akan segera hadir dalam waktu dekat</p>
        </div>
