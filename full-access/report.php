      ...
      <div class="col-2" style="margin-left: 1%; margin-right: 1%">
        ...
        <a href="report.php" class="sidebar-menu">
          <div class="row row-sidebar-menu">
            <div class="col-3">
              <img src="../Assets/Asset36.png" alt="" class="img-right-side" />
            </div>
      ...
      <div class="col">
        ...
        <nav class="navbar">
          ...
          <div class="row row-right-navbar">
            ...
            <div class="col">
              <a href="report.php" class="nav-item nav-text-dashboard">Report</a>
            </div>
        ...
        <div class="row">
          ...
          <div class="col">
            ...
            <div class="card card-style-2">
              ...
              <div class="progress mt-1">
                <div class="progress-bar-3" role="progressbar" style="width: 50%" aria-valuenow="15" aria-valuemin="0"
                  aria-valuemax="100"></div>
                <div class="progress-bar-2" role="progressbar" style="width: 30%" aria-valuenow="30" aria-valuemin="0"
                  aria-valuemax="100"></div>
                <div class="progress-bar-1" role="progressbar" style="width: 20%" aria-valuenow="20" aria-valuemin="0"
                  aria-valuemax="100"></div>
              </div>
              <!-- 0% to 100% label -->
              <div class="row mt-2">
          ...
          <div class="col">
            ...
            <div class="card card-style-2" style="height: 57%;">
              ...
              <div class="progress mt-1">
                <div class="progress-bar-1" role="progressbar" style="width: 70%" aria-valuenow="15" aria-valuemin="0"
                  aria-valuemax="100"></div>
                <div class="progress-bar-2" role="progressbar" style="width: 30%" aria-valuenow="30" aria-valuemin="0"
                  aria-valuemax="100"></div>
              </div>
        ...
        <div class="row mt-2">
          ...
          <div class="col">
            ...
            <div class="card card-style-2">
              ...
              <input class="form-control mt-2" type="text" placeholder="Search here"
                aria-label="default input example" />
          ...
          <div class="col">
            ...
            <div class="card card-style-2">
              ...
              <!-- date search  -->
              <input class="form-control mt-2" type="date" placeholder="Search here"
                aria-label="default input example" />
