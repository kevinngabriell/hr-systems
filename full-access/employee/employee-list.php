                            ...
                            <form action="" method="post">
                                <div class="row">
                                    <div class="col-3">
                                        ...
                                        <input class="form-control" type="text" placeholder="Nama karyawan"
                                            aria-label="Search">
                                    </div>
                                    <div class="col-3">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <a href="employee-details/employee-details.php?employee_id=<?php echo $employee_rows['id']; ?>"
                                                style="text-decoration: none;">
                                                <p>
                                                    <?php echo $employee_rows['employee_name'] ?>
                                                </p>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <td>
                                    <p>
                                        <?php echo $employee_rows['department_name'] ?>
                                    </p>
                                </td>
                                <td>
                                    <p>
                                ...
                                <td>
                                    <p>
                                        <?php echo $employee_rows['employee_status_name'] ?>
                                    </p>
                                </td>
                            </tr>
                            <?php
