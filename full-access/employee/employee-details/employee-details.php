    ...
    <div class="container-fluid">
        <div class="row h-100">
            ...
            <nav class="nav flex-column flex-sm-row">
                ...
                <a class="flex-sm-fill text-sm-center nav-link" href="employee-details-permohonan.html">Permohonan</a>
            ...
            <div class="row mt-4 d-flex">
                ...
                <div class="col-4">
                    <div class="card">
                        <div class="row d-flex mt-3 align-items-center">
                            <div class="col justify-content-center">
                                <a href="" style="text-decoration: none;">
                                    <img src="../../../Assets/Asset22.png" alt="" style="width: 70%; margin-bottom: 5%; display: flex; justify-content: center;">
                            ...
                            <div class="col justify-content-center">
                                <a href="" style="text-decoration: none;">
                                    <img src="../../../Assets/Asset23.png" alt="" style="width: 70%; margin-bottom: 5%; display: flex; justify-content: center;">
                                    <div class="menu-name-details-right-corner">
                                        Reset password
                                    </div>
                                </a>
                            ...
                            <div class="col justify-content-center">
                                <a href="" style="text-decoration: none;">
                                    <img src="../../../Assets/Asset24.png" alt="" style="width: 70%; margin-bottom: 5%; display: flex; justify-content: center;">
                                    <div class="menu-name-details-right-corner">
                                        Hapus akun
                                    </div>
                                </a>
                        ...
                        <div class="row mt-3 d-flex align-items-center mb-3">
                            <div class="col">
                                <a href="" style="text-decoration: none;">
                                    <img src="../../../Assets/Asset25.png" alt="" style="display: flex; width: 70%; margin-bottom: 5%;justify-content: center;">
                                    <div class="menu-name-details-right-corner">
                                        Tinjau
                                    </div>
                                </a>
                            ...
                            <div class="col">
                                <a href="" style="text-decoration: none;">
                                    <img src="../../../Assets/Asset26.png" alt="" style="width: 70%; margin-bottom: 5%; display: flex; justify-content: center;">
                                    <div class="menu-name-details-right-corner">
                                        Surat peringatan
                                    </div>
                                </a>
                            ...
                            <div class="col">
                                <a href="" style="text-decoration: none;">
                                    <img src="../../../Assets/Asset27.png" alt="" style="width: 70%; margin-bottom: 5%; display: flex; justify-content: center;">
                                    <div class="menu-name-details-right-corner">
                                        Soon
                                    </div>
                                </a>
