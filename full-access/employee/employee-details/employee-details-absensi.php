    ...
    <div class="container-fluid">
        <div class="row h-100">
            ...
            <nav class="nav flex-column flex-sm-row">
                <a class="flex-sm-fill text-sm-center nav-link" aria-current="page" href="employee-details.html">Overview</a>
                <a class="flex-sm-fill text-sm-center nav-link active" href="employee-details-absensi.html">Absensi</a>
