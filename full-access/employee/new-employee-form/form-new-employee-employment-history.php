            ...
            <div class="col">
                ...
                <form action="" method="post">
                        ...
                        <div class="col">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="company_position_1" id="company_position_1"
                                        class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                <div class="col">
                                    ...
                                    <textarea class="form-control" name="company_address_1" id="company_address_1"
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-3">
                                    ...
                                    <input type="date" name="company_date_from_1" id="company_date_from_1"
                                        class="form-control">
                                </div>
                                <div class="col-3">
                                    <label for="" class="form-new-employee-label mb-1">Sampai</label>
                                    <input type="date" name="company_date_to_1" id="company_date_to_1"
                                        class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                <div class="col">
                                    ...
                                    <input type="text" name="company_leader_1" id="company_leader_1"
                                        class="form-control">
                                </div>
                                <div class="col">
                                    <label for="" class="form-new-employee-label mb-1">Gaji</label>
                                    <input type="number" name="company_salary_1" id="company_salary_1"
                                        class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mt-4 mb-4">
                                <div class="col">
                                    ...
                                    <textarea class="form-control" name="company_job_desc_1" id="company_job_desc_1"
                                        cols="10" rows="3"></textarea>
                                </div>
                                <div class="col">
                                    <label for="" class="form-new-employee-label mb-1">Alasan keluar</label>
                                    <textarea class="form-control" name="company_exit_1" id="company_exit_1" cols="10"
                                        rows="3"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col">
                                    <label for="" class="form-new-employee-label mb-1">Posisi</label>
                                    <input type="text" name="company_position_2" id="company_position_2"
                                        class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                <div class="col">
                                    <label for="" class="form-new-employee-label mb-1">Alamat perusahaan</label>
                                    <textarea class="form-control" name="company_address_2" id="company_address_2"
                                        cols="10" rows="3"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-3">
                                    <label for="" class="form-new-employee-label mb-1">Dari</label>
                                    <input type="date" name="company_date_from_2" id="company_date_from_2"
                                        class="form-control">
                                </div>
                                <div class="col-3">
                                    <label for="" class="form-new-employee-label mb-1">Sampai</label>
                                    <input type="date" name="company_date_to_2" id="company_date_to_2"
                                        class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                <div class="col">
                                    <label for="" class="form-new-employee-label mb-1">Atasan</label>
                                    <input type="text" name="company_leader_2" id="company_leader_2"
                                        class="form-control">
                                </div>
                                <div class="col">
                                    <label for="" class="form-new-employee-label mb-1">Gaji</label>
                                    <input type="number" name="company_salary_2" id="company_salary_2"
                                        class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mt-4 mb-4">
                                <div class="col">
                                    <label for="" class="form-new-employee-label mb-1">Deskripsi pekerjaan</label>
                                    <textarea class="form-control" name="company_job_desc_2" id="company_job_desc_2"
                                        cols="10" rows="3"></textarea>
                                </div>
                                <div class="col">
                                    <label for="" class="form-new-employee-label mb-1">Alasan keluar</label>
                                    <textarea class="form-control" name="company_exit_2" id="company_exit_2" cols="10"
                                        rows="3"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col">
                                    <label for="" class="form-new-employee-label mb-1">Posisi</label>
                                    <input type="text" name="company_position_3" id="company_position_3"
                                        class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                <div class="col">
                                    <label for="" class="form-new-employee-label mb-1">Alamat perusahaan</label>
                                    <textarea class="form-control" name="company_address_3" id="company_address_3"
                                        cols="10" rows="3"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-3">
                                    <label for="" class="form-new-employee-label mb-1">Dari</label>
                                    <input type="date" name="company_date_from_3" id="company_date_from_3"
                                        class="form-control">
                                </div>
                                <div class="col-3">
                                    <label for="" class="form-new-employee-label mb-1">Sampai</label>
                                    <input type="date" name="company_date_to_3" id="company_date_to_3"
                                        class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                <div class="col">
                                    <label for="" class="form-new-employee-label mb-1">Atasan</label>
                                    <input type="text" name="company_leader_3" id="company_leader_3"
                                        class="form-control">
                                </div>
                                <div class="col">
                                    <label for="" class="form-new-employee-label mb-1">Gaji</label>
                                    <input type="number" name="company_salary_3" id="company_salary_3"
                                        class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                <div class="col">
                                    <label for="" class="form-new-employee-label mb-1">Deskripsi pekerjaan</label>
                                    <textarea class="form-control" name="company_job_desc_3" id="company_job_desc_3"
                                        cols="10" rows="3"></textarea>
                                </div>
                                <div class="col">
                                    <label for="" class="form-new-employee-label mb-1">Alasan keluar</label>
                                    <textarea class="form-control" name="company_exit_3" id="company_exit_3" cols="10"
                                        rows="3"></textarea>
                                </div>
                            </div>
                    ...
                    <button type="submit" id="submit" name="submit"
                        class="btn mt-4 mb-5 btn-submit-form-employee align-items-end">Next</button>
                </form>
