...
if(isset($_POST['submit'])){
    ...
    if($employee_name == null){
        ...
        if($employee_identity_length >= 10){
            ...
            //insert data query
            $employee_insert_query = "INSERT IGNORE INTO employee (id, employee_id, employee_name, employee_status_id, department_id, position_id, company_id, gender, employee_pob, employee_dob, employee_nationality, employee_identity, employee_jamsostek, employee_status, employee_religion) VALUES (NULL, NULL, '$employee_name', 'ES-HR-001', '$employee_department', '$employee_position', 'COM-HR-001', '$employee_gender', '$employee_pob', '$employee_dob', '$employee_nationality', '$employee_identity_number', '$employee_jamsostek_number', '$employee_status', '$employee_religion');";
    ...
    <div class="container-fluid">
        <div class="row h-100">
            ...
            <form action="" method="post">
                ...
                <button type="submit" id="submit" name="submit" class="btn mt-4 btn-submit-form-employee align-items-end">Next</button>
            </form>
