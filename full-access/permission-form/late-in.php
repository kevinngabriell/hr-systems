...
if (isset($_POST['submit'])) {
    ...
    $insert_late_in_query = "INSERT IGNORE INTO late_in_log (id_late_in, employee_id, date, reason, absen_time, status, reject_reason, request_date, last_updated_date) VALUES ('$random_id', '$employee_id', '$date', '$reason', '$absen_time', '$set_status', NULL, '$current_date', '$current_date');";
